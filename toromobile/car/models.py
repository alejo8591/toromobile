...
class CarColor(models.Model):
    ...
    toro_cc_description = models.CharField(max_length=4, verbose_name='Descripción', help_text="Nombre completo del Color")
    def __unicode__(self):
...
class CarBodyWork(models.Model):
    ...
    toro_cbw_description = models.CharField(max_length=4, verbose_name='Descripción', help_text="Nombre completo del tipo de carroceria")
    def __unicode__(self):
...
class Car(models.Model):
   ...
   toro_car_mark = models.ForeignKey(CarMark)
   toro_car_line = models.ForeignKey(CarLine)
   ...
   toro_car_bodyWork = models.ForeignKey(CarBodyWork)
   ...
   toro_car_owner = models.ForeignKey(CarOwner)
   toro_car_mandated = models.ForeignKey(CarMandated)
   date_pub_event = models.DateField(default=datetime.now, auto_now = False, editable=False, verbose_name='Fecha de creación vehiculo')
   #Optimización para ver en el admin site de Django
   def __unicode__(self):
       return u'%s %s' %(self.toro_car_plate, self.toro_car_bodyWork)
