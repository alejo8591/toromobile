...
class CarDriver(models.Model):
    ...
    toro_cd_name = models.CharField(max_length=12, verbose_name='Nombre(s)', help_text="Nombre(s) del conductor del vehiculo")
    ...
    def __unicode__(self):
       return u'%s %s %s' %(self.toro_cd_id, self.toro_cd_first_name, self.toro_cd_name)
    class Meta:
        ordering = ['toro_cd_id']
